...
public class DayActivity extends BaseActivity {
	...
	protected void onResume() {
		...
		if (state) {
			...
			if (dayNote != null) {
				...
				if (!dayNote.getBegin_or_end_pille_date().equalsIgnoreCase("-")) {
					pilleneinnahme
							.setText(dayNote.getBegin_or_end_pille_date());
					pilleneinnahme.invalidate();
			...
			if (arz.equals("-")) {
				...
				if (arz.equals("") && dayNote != null
						&& dayNote.getArzttermin() != null
			...
			if (begin_ende.equals("-")) {
				...
				if (begin_ende.equals("") && dayNote != null
						&& dayNote.getBegin_or_end_pille_date() != null
	...
	private void saveToDB() {
		...
		// SharedPreferences.Editor editor = sharedPreferences.edit();
		// /*
		// * public static final String DATE = "date"; public static final
		// String
		// * STIMMUNGS = "stimmungs"; public static final String SYMPTOMES =
		// * "symptomes"; public static final String MENSTRUATION =
		// * "menstruation"; public static final String ARZTTERMIN =
		// "arzttermin";
		// * public static final String BEGIN_ENDE = "begin_ende";
		// */
		// editor.remove(DATE);
		...
		if (dayNote.getBegin_or_end_pille_date() != null
			...
			if (!sharedPreferences2.contains(FIRST_DAY)) {
				...
				Toast.makeText(
						this,
						"currentdayn = " + currentDay + " dayOfStart = "
								+ dayOfStart, Toast.LENGTH_SHORT).show();
				editor2.putInt(COUNT, startPositon);
